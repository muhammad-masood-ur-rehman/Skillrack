Filling Cans
Two cans are with capacity X and y liters.The program must determine the number of steps required to obtain exactly Z liters of liquid one of the cans.
At the beginning both the cans are empty.The following operations are countered as “steps”:
->emptying a vessel
->filling a vessel
->pouring liquid from larger can to the smaller, without spilling untill one of the cans is either full or empty.
